...
private:
    ...
    {
        // GenericTextPacket - used when no specific TextPacket is registered
        // Holds the TextParse object parsed by packet_decoder.hpp
        ...
        // GenericVariantPacket - used when no specific VariantPacket is registered
        // Holds the PacketVariant object parsed by packet_decoder.hpp
        ...
        // GenericGamePacket - used when no specific GamePacket is registered
        // Holds the GameUpdatePacket and extra data parsed by packet_decoder.hpp
