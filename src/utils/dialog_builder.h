...
private:
    std::string get_direction(const direction& dir)
    {
        ...
        case direction::STATIC_BLUE_FRAME:return "staticBlueFrame";
        default:return "";
        }
        return "";
    }
...
public:
    ...
    dialog_builder* add_label_with_icon(const std::string& label, const int& itemId, const direction& dir = LEFT,
        const size_type& label_size = SMALL)
    {
        m_result.append(
            fmt::format("\nadd_label_with_icon|{}|{}|{}|{}|", label_size == size_type::SMALL ? "small" : "big",
                label, this->get_direction(dir), itemId));
        return this;
    }
